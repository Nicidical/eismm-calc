...
export function isQPActive(
  ...
  return (
    ...
    (pokemon.hasAbility('Aquaform') &&
      (weather.includes('Rain') || pokemon.hasItem('Booster Energy'))) ||
    (pokemon.hasAbility('Lithoforge') &&
      (weather.includes('Sand') || pokemon.hasItem('Booster Energy'))) ||
    (pokemon.hasAbility('Cryogenesis') &&
      (weather.includes('Hail') || weather.includes('Snow') || pokemon.hasItem('Booster Energy'))) ||
    (pokemon.hasAbility('Quark Drive') &&
      (terrain === 'Electric' || pokemon.hasItem('Booster Energy'))) ||
    (pokemon.hasAbility('Verdaboost') &&
      (terrain === 'Grassy' || pokemon.hasItem('Booster Energy'))) ||
    (pokemon.hasAbility('Psionization') &&
      (terrain === 'Psychic' || pokemon.hasItem('Booster Energy'))) ||
    (pokemon.hasAbility('Migirise') &&
      (terrain === 'Misty' || pokemon.hasItem('Booster Energy'))) ||
