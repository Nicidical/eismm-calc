...
const MARIOMON_PATCH: {[name: string]: DeepPartial<SpeciesData>} = {
  // https://www.youtube.com/watch?v=MbSNABeg5Eo (Has all Weights)
  'Amazy Dayzee': {
    types: ['Fairy'],
    bs: {hp: 65, at: 40, df: 30, sa: 140, sd: 75, sp: 80},
    weightkg: 25.3,
    abilities: {0: 'Run Away'},
  },
  'Angry Sun': {
  ...
  'Bomb-Omb': {
    types: ['Fire'],
    bs: {hp: 100, at: 70, df: 25, sa: 50, sd: 20, sp: 30},
    weightkg: 22.9,
    abilities: {0: 'Blaze'},
    nfe: true,
  },
  ...
  Broozer: {
    types: ['Ghost', 'Fighting'],
    bs: {hp: 60, at: 100, df: 100, sa: 30, sd: 75, sp: 110},
    weightkg: 100,
    abilities: {0: 'Iron Fist'},
  },
  'Bubble Blooper': {
  ...
  'Chill Bully': {
    types: ['Ice', 'Rock'],
    bs: {hp: 75, at: 110, df: 145, sa: 45, sd: 70, sp: 60},
    weightkg: 100,
    abilities: {0: 'Ice Body'},
  },
  'Chill Virus': {
  ...
  'Ghost Mouse': {
    types: ['Ghost'],
    bs: {hp: 30, at: 60, df: 40, sa: 23, sd: 35, sp: 75},
    weightkg: 100,
    abilities: {0: 'Frisk'},
    nfe: true,
  },
  ...
  Handfake: {
    types: ['Dark'],
    bs: {hp: 105, at: 120, df: 60, sa: 120, sd: 60, sp: 50},
    weightkg: 100,
    abilities: {0: 'Illusion'},
  },
  'Happy Moon': {
  ...
  Parabiddy: {
    types: ['Normal', 'Flying'],
    bs: {hp: 70, at: 80, df: 70, sa: 70, sd: 60, sp: 75},
    weightkg: 100,
    abilities: {0: 'Keen Eye'},
  },
  Paratroopa: {
  ...
  Pidgit: {
    types: ['Psychic', 'Flying'],
    bs: {hp: 60, at: 50, df: 45, sa: 90, sd: 80, sp: 100},
    weightkg: 100,
    abilities: {0: 'Magic Bounce'},
  },
  'Piranha Plant': {
  ...
  Wiggler: {
    types: ['Bug', 'Fighting'],
    bs: {hp: 70, at: 125, df: 105, sa: 60, sd: 75, sp: 60},
    weightkg: 100,
...
const SV: {[name: string]: SpeciesData} = extend(true, {}, MARIOMON_PATCH);
